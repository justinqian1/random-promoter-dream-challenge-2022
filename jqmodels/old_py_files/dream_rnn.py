...
trainer = AutosomeTrainer(
    ...
    model_dir=f"../../../../../../scratch/st-cdeboer-1/justin/models/rnn_{SEED}",
    dataprocessor=dataprocessor,
    num_epochs=NUM_EPOCHS,
    lr = lr)
trainer.fit()

predictor = AutosomePredictor(model=model, model_pth=f"../../../../../../scratch/st-cdeboer-1/justin/models/rnn_{SEED}/model_best.pth", device=torch.device(f"cuda:0"))
